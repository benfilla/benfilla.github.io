...
$e_body = "You have been contacted by $faname $laname. Contact number is $phone and company name $company. Their additional message is as follows." . PHP_EOL . PHP_EOL;
$e_content = "\"$comments\"" . PHP_EOL . PHP_EOL;
$e_reply = "You can contact $faname via email";

$msg = wordwrap( $e_body . $e_content . $e_reply, 70 );

$headers = "From: $faname" . PHP_EOL;
$headers .= "Reply-To: $faname" . PHP_EOL;
